	...
	angular
        ...
        $(element).toggleClass("check");
			...
			$scope.showAviso = function() {
				...
				setTimeout(function() {$("#link-aviso").click()}, 1000);
			}
			...
			$scope.validateForm = function() {
				return !$scope.myform.$pristine && $scope.myform.nombre.$valid &&
						$scope.myform.apellidos.$valid &&
						$scope.myform.ine.$valid &&
						$scope.myform.email.$valid &&
						$scope.myform.cel.$valid
			}
