(function() {
	...
	angular
		...
		//		operationData.opClass = 168;
				...
				usertoLogin.username = 'webexterna';
				var pwdHashed = CryptoJS.SHA256("Galeon123");
				...
				$http({
					method: 'POST',
					url: 'https://demos3.galeonsoftware.com/repomanager/services/repository/login',
					...
					$http({
						method: 'POST',
						url: 'https://demos3.galeonsoftware.com/repomanager/services/operations/newoperationmultilevel/107',
						data: objectToSend,
						headers: {
						...
						console.log(uuid);
						$scope.detailFrame = $sce.trustAsResourceUrl("https://demos3.galeonsoftware.com/ESign/esignservices/esign/signop/"+uuid+"/" + uuid );
						$scope.ready = true;
						console.log(".....");
