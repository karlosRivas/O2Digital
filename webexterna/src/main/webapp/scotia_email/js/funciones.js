...
//console.log(slideEvt.value);
  ...
  $('#IngresoMinimo24').val('$7,500').trigger('output');
  $('#IngresoMinimo36').val('$15,000').trigger('output');
  $('#IngresoMinimo48').val('$45,000').trigger('output');
  $('#IngresoMinimo60').val('$100,000').trigger('output');

  $('#PagoMensual24').val('$600').trigger('output');
  $('#PagoMensual36').val('$850').trigger('output');
  $('#PagoMensual48').val('$1,950').trigger('output');
  $('#PagoMensual60').val('$4,200').trigger('output');
...
$("#LinkCredito").click(function(){
 ...
 $('#tabla').iCheck({
  ...
  //var tiposTarjetas=$("#tiposTarjetas").val(); //obtener el valor del option del select
  //var tiposTarjetas=$("#tiposTarjetas option:selected" ).text(); //obtener el tecto del option del select
...
$("#BtnContinuar").click(function(){
      ...
      //var tipoTarjeta=$("input[name='CheckBoxMeses']:checked").val();
...
var tipoTarjeta=$("input[name='CheckBoxMeses']:checked").val();
console.log(tipoTarjeta);
$('#tarjetaFinal').val(tipoTarjeta).trigger('output');

if(tipoTarjeta==="Scotia Travel Clásica"){
 $('#anualidad').val("$600.00 MXN").trigger('output');
}

if(tipoTarjeta==="Scotia Travel Oro"){
 $('#anualidad').val("$850.00 MXN").trigger('output');
}

if(tipoTarjeta==="Scotia Travel Platinum"){
 $('#anualidad').val("$1,950.00 MXN").trigger('output');
}

if(tipoTarjeta==="Scotia Travel World Elite"){
 $('#anualidad').val("$4,200.00 MXN").trigger('output');
}
